...
namespace ChuckDeviceConfigurator.Migrations
{
    ...
    [Migration("20230110091440_AddControllerConstraints")]
    partial class AddControllerConstraints
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ChuckDeviceController.Data.Entities.Account", b =>
                {
                    ...
                    b.HasIndex("LastEncounterTime");

                    b.HasIndex("LastUsedTimestamp");
                    ...
                    b.HasIndex("LastEncounterLatitude", "LastEncounterLongitude");
            ...
            modelBuilder.Entity("ChuckDeviceController.Data.Entities.Device", b =>
                {
                    b.HasOne("ChuckDeviceController.Data.Entities.Account", "Account")
                        .WithOne("Device")
                        .HasForeignKey("ChuckDeviceController.Data.Entities.Device", "AccountUsername")
