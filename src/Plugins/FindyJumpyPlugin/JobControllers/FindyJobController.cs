namespace FindyJumpyPlugin.JobControllers
{
    ...
    public class FindyJobController : IJobController, IJobControllerCoordinates, IScanNextInstanceController
    {
        ...
        public async Task<ITask> GetTaskAsync(TaskOptions options)
        {
            ...
            Console.WriteLine($"TTH - oldLoc={loc} & newLoc={newLoc}/{_tthCoords.Count:N0}");
        ...
        private void InitTthCoords()
        {
            Console.WriteLine($"InitTthCoords: Starting...");
            ...
            lock (_tthLock)
            {
                ...
                Console.WriteLine($"InitTthCoords: Got {count:N0} points in min/max rectangle with null tth");
                Console.WriteLine($"InitTthCoords: Got {tmpCoords.Count:N0} points in geofence(s) with null tth");
