...
public static class ControllerContextExtensions
{
    ...
    public static async Task<Account?> GetAccountAsync(this ControllerDbContext context, string username)
    {
        var account = await context.Accounts.FindAsync(username);
        return account;
    }

    public static async Task<Account?> GetNewAccountAsync(this ControllerDbContext context,
    ...
    public static Account? GetNewAccount(this ControllerDbContext context,
