...
public interface IConfigurationHost
{
    ...
    ///     Name of the JSON file name to be used. If a JSON cofiguration file is not provided, the default 'appsettings.json' will be loaded from the calling plugin's root folder.
    /// </param>
