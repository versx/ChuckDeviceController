...
public class PvpRankGenerator : IPvpRankGenerator
{
    ...
    public IReadOnlyList<PvpRank> GetPvpStats(
    ...
    public IReadOnlyDictionary<string, dynamic>? GetAllPvpLeagues(
        HoloPokemonId pokemon,
        PokemonForm? form,
    ...
    public IReadOnlyList<PvpRank>? GetTopPvpRanks(
        HoloPokemonId pokemon,
        PokemonForm? form,
        PvpLeague league)
    {
    ...
    private List<(PokemonWithFormAndGender, PvpRank)> GetPvpStatsWithEvolutions(
        HoloPokemonId pokemon,
        PokemonForm? form,
        PokemonGender? gender,
        PokemonCostume? costume,
