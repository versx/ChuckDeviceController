...
{
    public const string DefaultProxyHttpClientName = "ChuckProxyClient";
    ...
    public static ForwardContext ForwardTo(this HttpContext context, UpstreamHost upstreamHost, string httpClientName = DefaultProxyHttpClientName)
    {
